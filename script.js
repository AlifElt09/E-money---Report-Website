    ...
    if (txns.length === 0) {
      ...
      tbody.innerHTML = txns.map((t, i) => `
        <tr class="hover:bg-gray-50">
          ...
          <td class="px-4 py-3">
            <!-- ✅ EXACTLY your original button styles -->
            <button onclick="edit(${i})" class="text-white bg-blue-700 px-3 py-1.5 mr-2 rounded mb-1.5"><i class="fas fa-edit"></i> Edit</button>
